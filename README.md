...
## Helpful Links for Me the Developer
[Basic Next API route setup](https://medium.com/@patel.d/quick-guide-add-get-api-in-next-js-13-app-router-69f6e5e938be)

[Prisma Docs](https://www.prisma.io/docs/orm)

[Project based on](https://github.com/prisma/prisma-examples/tree/latest/typescript/rest-nextjs-api-routes)
